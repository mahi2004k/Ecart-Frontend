...
const AdminSales = () => {
  ...
  const fetchStats = async()=>{
    try {
      ...
      const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/orders/sales`, {
        headers: {
  ...
  return (
    <div className='pl-[350px] bg-gray-100 py-20 pr-20 mx-auto min-h-screen min-w-screen px-4'>
      <div className='p-6 grid gap-6 lg:grid-cols-4'>
        {/* stats card  */}
        <Card className='bg-yellow-500 text-white shadow'>
          <CardHeader>
